...
public class JavaApi extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(rnum!=null)
		{
			switch(rnum)
			{
				...
				case "12":feedback(request,response);break;
				case "13":getChuan(request,response);break;
				case "14":getHui(request,response);break;
				case "15":getLu(request,response);break;
				case "16":getMin(request,response);break;
				case "17":getSu(request,response);break;
				case "18":getXiang(request,response);break;
				case "19":getYue(request,response);break;
				case "20":getZhe(request,response);break;
				case "21":getorderlistbyorderid(request,response);break;
			}
		}
		else {
	...
	protected void getorderlistbyorderid(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
	...
	protected void userreg(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		...
		String StrSql1="insert into tbmember (username,password,truename,tel,address,number) values (?,?,?,?,?,?)";
	...
	//用户反馈
	protected void feedback(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		String content=request.getParameter("content");
		String tel=request.getParameter("tel");
		String address=request.getParameter("address");
		String StrSql1="insert into feedback (content,tel) values (?,?)";
		List<Object> params1 = new ArrayList<Object>();
		params1.add(content);
		params1.add(tel);
		DBHelper Dal=new DBHelper();
	...
	{
		DBHelper Dal=new DBHelper();
		String strSqlpager=" select * from tbproduct order by rand()";
	...
	//获取川菜列表
	protected void getChuan(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		DBHelper Dal=new DBHelper();
		String strSqlpager=" select * from tbproduct where kind='川菜' order by rand()";
		List<Map<String, Object>> listpage = null;
		try {
			List<Object> params = new ArrayList<Object>();
			listpage=Dal.executeQuery(strSqlpager, params);
	...
	//获取徽菜列表
	protected void getHui(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		DBHelper Dal=new DBHelper();
		String strSqlpager=" select * from tbproduct where kind='徽菜' order by rand()";
		List<Map<String, Object>> listpage = null;
		try {
			List<Object> params = new ArrayList<Object>();
			listpage=Dal.executeQuery(strSqlpager, params);
	...
	//获取鲁菜列表
	protected void getLu(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		DBHelper Dal=new DBHelper();
		String strSqlpager=" select * from tbproduct where kind='鲁菜' order by rand()";
		List<Map<String, Object>> listpage = null;
		try {
			List<Object> params = new ArrayList<Object>();
			listpage=Dal.executeQuery(strSqlpager, params);
	...
	//获取闽菜列表
	protected void getMin(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		DBHelper Dal=new DBHelper();
		String strSqlpager=" select * from tbproduct where kind='闽菜' order by rand()";
		List<Map<String, Object>> listpage = null;
		try {
			List<Object> params = new ArrayList<Object>();
			listpage=Dal.executeQuery(strSqlpager, params);
	...
	//获取苏菜列表
	protected void getSu(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		DBHelper Dal=new DBHelper();
		String strSqlpager=" select * from tbproduct where kind='苏菜' order by rand()";
		List<Map<String, Object>> listpage = null;
		try {
			List<Object> params = new ArrayList<Object>();
			listpage=Dal.executeQuery(strSqlpager, params);
	...
	//获取湘菜列表
	protected void getXiang(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		DBHelper Dal=new DBHelper();
		String strSqlpager=" select * from tbproduct where kind='湘菜' order by rand()";
		List<Map<String, Object>> listpage = null;
		try {
			List<Object> params = new ArrayList<Object>();
			listpage=Dal.executeQuery(strSqlpager, params);
	...
	//获取粤菜列表
	protected void getYue(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		DBHelper Dal=new DBHelper();
		String strSqlpager=" select * from tbproduct where kind='粤菜' order by rand()";
		List<Map<String, Object>> listpage = null;
		try {
			List<Object> params = new ArrayList<Object>();
			listpage=Dal.executeQuery(strSqlpager, params);
	...
	//获取浙菜列表
	protected void getZhe(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		DBHelper Dal=new DBHelper();
		String strSqlpager=" select * from tbproduct where kind='浙菜' order by rand()";
		List<Map<String, Object>> listpage = null;
		try {
			List<Object> params = new ArrayList<Object>();
			listpage=Dal.executeQuery(strSqlpager, params);
	...
	protected  void addtocar(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		...
		else
		{
			...
			//新增
			String strSql2="insert into tbshoppingcar (userid,proname,kind,proid,procount,ctime,imgurl,price) values(?,?,?,?,?,?,?,?) ";
			params.add(userid);
			params.add(obj.get("proname"));
			params.add(obj.get("kind"));
			params.add(proid);
			params.add(1);
	...
	protected void addToOrder(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		...
		String tbnumber=request.getParameter("tbnumber");
		String userid=request.getParameter("userid");
		...
		for (Map<String, Object> m : carprolist) {
			sum=sum+Double.parseDouble(m.get("price").toString())*Integer.parseInt(m.get("procount").toString());//鍟嗗搧鍗曚环*鍟嗗搧涓暟
		...
		String StrSql1="insert into tborderhead (orderid,sname,stel,saddress,snumber,sumprice,memberid,ctime) values (?,?,?,?,?,?,?,?)";
		List<Object> params1 = new ArrayList<Object>();
		params1.add(orderid);
		params1.add(tbname);
		params1.add(tbtel);
		params1.add(tbaddress);
		params1.add(tbnumber);
		params1.add(sum);
		params1.add(userid);
